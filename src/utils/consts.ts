...
export const PLAYER_LIST: Player[] = [
   ...
   {
      image: "player_images/Otavio.png",
      name: "Otavio",
      position: "Defensor",
   },
   {
   ...
   {
      image: "player_images/Justin.png",
      name: "Justin",
      position: "Atacante",
   },
   {
   ...
   {
      image: "player_images/Henrique_Carius.png",
